...
const ErrorScreen: ComponentType<ErrorScreenProps> = ({
  error,
  onRetry,
  onBack,
}) => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen p-6 text-white text-center">
        ...
        >
          <motion.div
            className="w-24 h-24 bg-gradient-to-br from-red-400 via-orange-400 to-pink-500 rounded-full flex items-center justify-center shadow-2xl"
            animate={{
              boxShadow: [
          ...
          >
            <AlertCircle className="w-12 h-12 text-white fill-current" />
          </motion.div>
        ...
        <motion.p
          className="text-white/80 text-lg sm:text-xl leading-relaxed max-w-md mb-8"
